...
mkdir -p build/PostProcessing
pushd build/PostProcessing

clang++ \
    -c \
    --target=wasm32 -nostdlib -g -DWEBASM -DASSIMP_BUILD_SINGLETHREADED -D__wasi__ -DNDEBUG -DNO_OPENGL3 \
    ...
    -DASSIMP_BUILD_NO_M3D_IMPORTER -DASSIMP_BUILD_NO_PBRT_EXPORTER\
    -fvisibility=hidden \
